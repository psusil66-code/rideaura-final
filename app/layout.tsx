...
function Header(){
  return <header className="top">
    ...
    <div className="container nav">
      ...
      <nav className="links"><Link href="/">Home</Link><Link href="/#fleet">Cars</Link><Link href="/#how">How It Works</Link><Link href="/#why">Destinations</Link><Link href="/about">About Us</Link><Link href="/contact">Contact</Link><Link href="/admin/login" className="login-link">Login / Signup</Link></nav>
