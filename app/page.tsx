...
export default function Home(){
  ...
  return <main>
    ...
    <section className="section local-search-section"><div className="container"><div className="title"><span className="eyebrow">Ride Aura Bhubaneswar</span><h2>Car and bike self-drive rental service near you</h2><p>Ride Aura Self Drive is built for customers searching for the best car rental service in Bhubaneswar, best bike rental service in Bhubaneswar, self drive near me, car self drive in Bhubaneswar and bike self drive service in Bhubaneswar. Book cars, bikes and scooters for city use, airport pickup, railway station pickup, Puri, Konark, Chilika and Odisha road trips.</p></div></div></section>
