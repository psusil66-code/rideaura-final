      ...
      <div className="container hero-stage">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <a className="btn ghost" href="/bikes">Bike Rent</a>
          </div>
