  ...
  return (
    <main className="handover-page">
      ...
      <style jsx>{`
        ...
        .handover-watermark{position:absolute;inset:0;display:grid;place-items:center;pointer-events:none;z-index:0;transform:rotate(-18deg)}
        .handover-watermark img{width:min(620px,82%);opacity:.10}
        .handover-watermark strong{position:absolute;font-size:96px;letter-spacing:10px;color:#07162d;opacity:.055;white-space:nowrap}
